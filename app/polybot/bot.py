...
def handle_image(message):
    try:
        ...
        # Save the file in the user's directory with a unique name
        ...
        if user_id in user_images:
            ...
            if 'concat_pending' in user_images[user_id]:
                ...
                del user_images[user_id]['concat_pending']  # Remove the pending flag
            ...
            # This is the first image and the user-specific directory
            print("This is the first image received")
            user_images[user_id] = {'concat_pending': image_path}
            bot.reply_to(message, "First image saved successfully! Now to apply concat filter please send another image or choose a filter from the list:\n"
                                  "- Blur\n"
                                  "- Rotate\n"
                                  "- Salt and Pepper\n"
                                  "- Segment\n"
